...
export type TrainingWhereInput = {
  ...
  attendeeIds?: Prisma.StringNullableListFilter<"Training">
...
export type TrainingCreateInput = {
  ...
  trainerName?: string | null
  date: Date | string
  attendeeIds?: Prisma.TrainingCreateattendeeIdsInput | string[]
...
export type TrainingUpdateInput = {
  ...
  attendeeIds?: Prisma.TrainingUpdateattendeeIdsInput | string[]
...
export type TrainingCreateattendeeIdsInput = {
  set: string[]
}

export type TrainingUpdateattendeeIdsInput = {
  set?: string[]
  push?: string | string[]
}
...
export type TrainingOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "title" | "description" | "trainerName" | "date" | "attendeeIds" | "createdAt", ExtArgs["result"]["training"]>
...
export interface TrainingFieldRefs {
  ...
  readonly attendeeIds: Prisma.FieldRef<"Training", 'String[]'>
