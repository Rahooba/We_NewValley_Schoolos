...
export default async function PresentStudentsPage() {
  ...
  return (
    <div>
      ...
      <h1 className="text-2xl font-display mb-1">الطلاب الحاضرون اليوم</h1>
            ...
            {records.length === 0 && (
              <tr>
                <td colSpan={4} className="px-4 py-10 text-center text-muted">
                  لا يوجد طلاب مسجلين كحاضرين اليوم بعد
                </td>
              </tr>
            )}
          </tbody>
