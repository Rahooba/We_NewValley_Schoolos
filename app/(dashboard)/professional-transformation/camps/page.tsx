  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-display mt-1">المعسكرات</h1>
        <p className="text-sm text-muted">سجل المعسكرات: القادة، الانطلاقة، التهيئة، الرواد — مسئول التحول الاحترافي</p>
      </div>
