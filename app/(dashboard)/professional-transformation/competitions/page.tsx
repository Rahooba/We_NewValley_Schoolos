...
export default async function CompetitionsPage({
  ...
  const where = { category: 'competition' };
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-display mt-1">مسابقات وتكريمات</h1>
        <p className="text-sm text-muted">مسابقات وشهادات تقدير — مسئول التحول الاحترافي</p>
      </div>
